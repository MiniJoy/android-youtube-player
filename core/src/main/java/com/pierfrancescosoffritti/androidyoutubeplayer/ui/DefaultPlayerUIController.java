...
public class DefaultPlayerUIController
        implements PlayerUIController, YouTubePlayerListener, YouTubePlayerFullScreenListener,
     ...
     * Could have used controlsRoot view, but in this way I'm able to hide all the control at once
     * by hiding controlsRoot
     */
    private View panel;
    ...
    public DefaultPlayerUIController(@NonNull YouTubePlayerView youTubePlayerView,
            @NonNull YouTubePlayer youTubePlayer) {
        this.youTubePlayerView = youTubePlayerView;
        this.youTubePlayer = youTubePlayer;

        View defaultPlayerUI = View
                .inflate(youTubePlayerView.getContext(), R.layout.default_player_ui,
                        youTubePlayerView);
    ...
    private void initViews(View controlsView) {
        ...
        syncButton = controlsView.findViewById(R.id.sync_button);
    ...
    public void setMenuButtonClickListener(
            @NonNull View.OnClickListener customMenuButtonClickListener) {
    ...
    @Override
    public void showSyncButton(boolean show) {
        int visibility = show ? View.VISIBLE : View.GONE;
        syncButton.setVisibility(visibility);
    }

    @Override
    public void setSyncButtonClickListener(View.OnClickListener listener) {
        if (listener != null) {
    ...
    public void setFullScreenButtonClickListener(
            @NonNull View.OnClickListener customFullScreenButtonClickListener) {
    ...
    private void onPlayButtonPressed() {
        if (isPlaying) {
            if (mPauseClickListener != null) {
                mPauseClickListener.onPauseClick();
            }
            youTubePlayer.pause();
        } else {
            if (mPauseClickListener != null) {
                mPauseClickListener.onPlayClick();
            }
            youTubePlayer.play();
        }
    }
    ...
    public void onStateChange(@NonNull PlayerConstants.PlayerState state) {
        ...
        if (state == PlayerConstants.PlayerState.PLAYING
            ...
            panel.setBackgroundColor(ContextCompat
                    .getColor(youTubePlayerView.getContext(), android.R.color.transparent));
            ...
            if (showCustomActionLeft) {
                customActionLeft.setVisibility(View.VISIBLE);
            }
            if (showCustomActionRight) {
    ...
    public void onCurrentSecond(float second) {
        ...
        if (newSeekBarProgress > 0 && !Utils.formatTime(second)
                .equals(Utils.formatTime(newSeekBarProgress))) {
            return;
        }
...
//        });
    ...
    @Override
    public void setPauseClickListener(OnPauseClickListener pauseClickListener) {
        mPauseClickListener = pauseClickListener;
    }
